...
class UserSalonsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_deleted' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'is_deleted' => '2017-09-29 13:45:30',
            'created' => '2017-09-29 13:45:30',
            'modified' => '2017-09-29 13:45:30'
        ],
    ];
}
