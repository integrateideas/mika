...
/**
 * ExpertLocationsFixture
 *
 */
class ExpertLocationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'country' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'US', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
