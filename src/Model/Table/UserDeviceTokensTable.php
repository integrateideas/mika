 ...
 * @method \App\Model\Entity\UserDeviceToken newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\UserDeviceToken[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\UserDeviceToken|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UserDeviceToken patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\UserDeviceToken[] patchEntities($entities, array $data, array $options = [])
